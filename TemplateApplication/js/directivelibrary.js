 ...
 * directive-library build:01-07-2016
 * Last update: added support for virtual Repeat scrolling
**/
...
*/
  ...
  return {
	...
	var client = $objectstore.getClient($scope.osNamespace,$scope.osClass, true);
